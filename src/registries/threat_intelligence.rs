// src/registries/threat_intelligence.rs
use super::*;
use serde_json::json;
...
/// Reprezentuje OSINT register pre vyhľadávanie zmienok na paste site.
#[derive(Debug, Default)]
pub struct PasteSiteMention;

impl PasteSiteMention {
...
#[async_trait]
impl OsintRegistry for PasteSiteMention {
    /// Názov modulu.
    ...
    fn type_id(&self) -> RegistryType {
        RegistryType::PasteSiteMention
    }
    /// Spustí dotaz na paste site (TODO: implementovať reálnu logiku).
